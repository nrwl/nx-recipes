...
- `yarn storybook@latest automigrate --config-dir libs/storybook-host-react/.storybook --renderer @storybook/react`

- `yarn storybook@latest automigrate --config-dir libs/client/ui/footer/.storybook --renderer @storybook/angular`

- `yarn storybook@latest automigrate --config-dir libs/client/ui/header/.storybook --renderer @storybook/angular`

- `yarn storybook@latest automigrate --config-dir libs/storybook-host-angular/.storybook --renderer @storybook/angular`
